package com.slipper.service.token.service.impl;
...
public class TokenServiceImpl extends ServiceImpl<TokenDao, TokenEntity> implements TokenService {
    ...
    public TokenEntity createToken(Long userId) {
        ...
        // 判断是否有token记录
        TokenEntity tokenObj = this.getById(userId);
        // 设置token信息
    ...
    @Override
    public TokenEntity queryByUserId(Long adminId) {
        return baseMapper.queryByUserId(adminId);
    }
}